# -*- coding: utf-8 -*-
#
# Tara Python Wrapper documentation build configuration file, created by
...
htmlhelp_basename = 'Tara Python Wrapperdoc'
...
latex_documents = [
  ('index', 'tara-py.tex', u'Tara Python Wrapper Documentation',
...
man_pages = [
    ('index', 'tara-py', u'Tara Python Wrapper Documentation',
     [u'H. Sinan Alioglu'], 1)
]
